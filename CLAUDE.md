...
Social media feed app — Node.js/Express backend, vanilla HTML/CSS/JS frontend, in-memory storage, deployed to Vercel.
...
2. **Integration tests** — Test component interactions with real API endpoints.
